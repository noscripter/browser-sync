...
(function (window, socket) {
    ...
    var ghost = {
        ...
        getInputByIndex: function (elem) {
            var allElems = document.getElementsByTagName(elem.tagName);
            return Array.prototype.indexOf.call(allElems, elem);
        },
        emitInputByIndex: function (elem) {

            var tagName = elem.tagName;
            var index = ghost.getInputByIndex(elem);
            ...
            ghost.emitEvent("input:type", obj);
        },
        listeners: {
            scroll: function () {
            ...
            checkboxChange: function (event) {
                ...
                ghost.emitEvent("input:checkbox", { id: elem.id, checked: elem.checked });
            },
    ...
    socket.on("input:update", function (data) {
        ...
        if (data.id) {
            elem = ghost.checkCache(scope.ghostMode.cache, data.id);
        } else {
            elems = document.getElementsByTagName(data.tagName);
