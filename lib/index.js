...
var updateCheck = require("update-checker");
...
var setup = {
    ...
    kickoff: function (files, config) {
        ...
        if (config.updateCheck) {
            updateCheck.checkForUpdate("browser-sync", pjson.version).then(function (newer) {
                if (newer) {
                    console.log(messages.update.prompt(newer, pjson.version));
                } else {
                    console.log(messages.update.confirm());
                }
            }).done(function () {
                start();
            });
